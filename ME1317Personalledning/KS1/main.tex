...
\begin{document}
	...
	\end{figure}
	Det finns \textbf{4 perspektiv} for \textbf{co-operation}:
	\textit{egoist, unitarist, pluralist och kritik} dessa perspektiv
	lägger dock mer tonvikt på konflikt än samarbete genom att expandera
	dessa får vi 6 perspektiv. \textit{Se tabell}. För att
	särskilja perspektiven finns \textbf{5 aspekter} att analysera:
	\textit{"Vem som jobbar tillsammans?", "Kompabilitet av intressen",
	"Hur mycket ömsesidighet", "Vilken typ av anställdas röst",
	"Samarbete för vilka problem"}? \textbf{Vem jobbar
	tillsammans?:} Organisation, individ, facket närvarande?
	\textbf{Kompabilitet av intressen:} Kompabilitet är ett spektrum
	hur kompabila intressena är beror på perspektivet. \textbf{Ömsesidighet:}
	Med \textbf{ömsesidighet} menas hur stor acceptans och
	ansvar varje deltagare har av den andra deltagarens
	intressen. \textbf{Typ av anställdas röst behövs: }Det vill
	säga i hur stort inflytande anställda har i den beslutfattande
	processen. \textbf{Samarbete över vilka problem?:} Problem i
	samarbete kan ske vara på olika nivåer. Problemen kan vara
	helt oförenliga eller insignifikanta verksamhets problem.
